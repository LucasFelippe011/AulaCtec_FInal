...
if($resultado) {
    echo '<script>alert("Usuário cadastrado com sucesso!");  window.location.href="adm-login.php"; </script>';
    exit();
   // Encerra a execução do script para garantir que o redirecionamento seja realizado
} else {
