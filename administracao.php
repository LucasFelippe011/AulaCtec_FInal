...
$query_rs_curso = "SELECT * FROM tb_cursos INNER JOIN tb_areas ON tb_cursos.idArea = tb_areas.idArea WHERE tb_cursos.ativo = 1 AND tb_areas.idArea = 1 ORDER BY tb_cursos.idCurso DESC";
...
<title>Cursos da área de Adm - Ctec</title>
<!-- Breve descrição do site para o google máx. 147 -->
<meta name="description" content="Cursos de tecnologia na área de Administração.">
<meta name="keywords" content="desenvolvimento, cursos, tecnologia, ti, html5, css3, php, javascript, script, treinamento, website, site, boostrap, adm, administração">
...
<h1 class="fonte-zero">Cursos da área de Adm - Ctec</h1>    
